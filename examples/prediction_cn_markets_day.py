...
Notes (personal):
    - Increased LOOKBACK from 400 to 480 to give the model more historical context;
      seemed to improve trend continuity in my tests on mid-cap stocks.
    - Bumped SAMPLE_COUNT to 3 so I can inspect variance across samples.
"""
...
DEVICE = "cpu"  # "cuda:0"
MAX_CONTEXT = 512
LOOKBACK = 480   # increased from 400 for richer historical context
PRED_LEN = 120
T = 1.0
TOP_P = 0.9
SAMPLE_COUNT = 3  # increased from 1 to inspect prediction variance
